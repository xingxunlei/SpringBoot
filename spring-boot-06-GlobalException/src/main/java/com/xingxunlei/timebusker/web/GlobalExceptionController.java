...
import com.xingxunlei.timebusker.exception.ErrorMassage;
import com.xingxunlei.timebusker.exception.MineException;
 ...
 *
 * @ControllerAdvice 统一定义不同Exception映射到不同错误处理页面
 *
