...
import static com.xingxunlei.timebusker.utils.DateUtil.*;
...
// ==========================================================匹配切点表达式========================================================================================
    ...
    // 匹配com.xingxunlei.timebusker.service包及子包下的任何方法执行
    @Pointcut(value="execution(* com.xingxunlei.timebusker.service.*.*(..))")
    public void log1() {
    }
    ...
    // 匹配任何返回值类型的com.xingxunlei.timebusker包及任何子包下的以add开头的参数为String类型的方法执行
    @Pointcut(value = "execution(* com.xingxunlei.timebusker..add*(String))")
    public void log6() {
    }

    // 匹配 OR、AND
    @Pointcut(value = "execution(* com.xingxunlei.timebusker.service.*.add*(int))")
    public void log7() {
    }

    // 匹配 OR、AND、
    @Pointcut(value = "execution(* com.xingxunlei.timebusker.service.*.add*(int)) OR execution(* com.xingxunlei.timebusker..add*(String))")
    public void log8() {
    }
    ...
    // 匹配指定类型内的方法执行--只能匹配类型
    @Pointcut(value = "within(com.xingxunlei.timebusker.service.order.impl.OrderInfoServiceImpl)")
    public void logw1() {
    }

    // 匹配指定类型内的方法执行(包下所有的类)
    @Pointcut(value = "within(com.xingxunlei.timebusker.service.order.impl.*)")
    public void logw2() {
    }
    ...
    // 匹配指定类型内的方法执行(包下所有的类)
    @Pointcut(value = "this(com.xingxunlei.timebusker.service.order.OrderInfoService)")
    public void logt1() {
    }
    ...
    // 匹配指定类型内的方法执行(包下所有的类)
    @Pointcut(value = "target(com.xingxunlei.timebusker.service.order.OrderInfoService)")
    public void logt2() {
    }
    ...
    @Pointcut(value = "@within(com.xingxunlei.timebusker.annotation.timebuskerBean)")
    public void logaw2() {
    }
    ...
    @Pointcut(value = "@annotation(com.xingxunlei.timebusker.annotation.timebuskerMethod)")
    public void logaa1() {
    }
...
// ==========================================================匹配切点表达式========================================================================================
    ...
    public void beforeAdvice(JoinPoint point) {
        ...
        logger.info("LoggerHandlerAop.beforeAdvice...time:" + now());
    ...
    public void afterReturningAdvice() {
        ...
        logger.info("LoggerHandlerAop.afterReturningAdvice...time:" + now());
    }
    ...
    public void afterThrowingAdvice() {
        ...
        logger.info("LoggerHandlerAop.afterThrowingAdvice...time:" + now());
    }
    ...
    public void afterFinallyAdvice() {
        ...
        logger.info("LoggerHandlerAop.afterFinallyAdvice...time:" + now());
    }
    ...
    public Object aroundAdvice(ProceedingJoinPoint pjp) {
        logger.info("LoggerHandlerAop.aroundAdvice...time:" + now());
        Object obj = null;
        try {
